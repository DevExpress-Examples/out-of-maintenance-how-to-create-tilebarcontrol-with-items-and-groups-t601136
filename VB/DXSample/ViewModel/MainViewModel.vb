...
Namespace DXSample.ViewModel
    Public Class MainViewModel
        ...
        Public Sub New()
            ...
            TileCollection.Add(New TileViewModel() With {
                               .Caption = "CategoryView",
                               .Children = New ObservableCollection(Of TileViewModel)() From
                               {New TileViewModel() With {
                               .Caption = "Category I",
                               .NavigateCommand = New DelegateCommand(Sub()
                                                                          Service.Navigate("SubCategory1View", Nothing, Me)
                                                                      End Sub)},
                               New TileViewModel() With {.Caption = "Category II",
                               .NavigateCommand = New DelegateCommand(Sub()
                                                                          Service.Navigate("SubCategory2View", Nothing, Me)
                                                                      End Sub)},
                               New TileViewModel() With {.Caption = "Category III",
                               .NavigateCommand = New DelegateCommand(Sub()
